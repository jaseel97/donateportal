            ...
            >
              <div className="flex-shrink-0 w-20 h-20 bg-gray-100 rounded-md overflow-hidden">
                {Array.isArray(item.images) && item.images.length > 0 ? (
                  ...
                  <div className="w-full h-full bg-gray-200"></div> // Empty div with a background
                )}
              </div>
              ...
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="text-lg font-medium text-gray-900">
                    {categories.find(cat => cat.id === selectedItem.item.category)?.name}
                  </h3>
            ...
            <div className="px-6 py-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">{selectedItem.item?.description}</p>
                </div>

                <div>
                  <h4 className="text-sm font-medium text-gray-900">Pickup Date</h4>
                  <p className="mt-1 text-sm text-gray-500">{formatDate(22 / 11 / 2024)}</p>
                </div>
